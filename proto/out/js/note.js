...
proto.claros.common.form.Note.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    timestamp: (f = msg.getTimestamp()) && proto.claros.common.ClarosDateTime.toObject(includeInstance, f),
...
/**
 * optional claros.common.ClarosDateTime timeStamp = 4;
...
proto.claros.common.form.Note.prototype.getTimestamp = function() {
  return /** @type{?proto.claros.common.ClarosDateTime} */ (
    jspb.Message.getWrapperField(this, proto.claros.common.ClarosDateTime, 4));
};
