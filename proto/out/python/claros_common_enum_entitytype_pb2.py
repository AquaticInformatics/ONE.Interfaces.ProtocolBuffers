...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='claros_common_enum_entitytype.proto',
  package='claros.common.configuration',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n#claros_common_enum_entitytype.proto\x12\x1b\x63laros.common.configuration*\x1e\n\nEntityType\x12\x10\n\x0c\x46ormTemplate\x10\x00\x62\x06proto3')
)
...
_ENTITYTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='FormTemplate', index=0, number=0,
      serialized_options=None,
      type=None),
  ],
