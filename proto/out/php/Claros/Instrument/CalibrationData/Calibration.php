...
/**
 * Generated from protobuf message <code>claros.instrument.CalibrationData.Calibration</code>
 */
class Calibration extends \Google\Protobuf\Internal\Message
{
    ...
    private $r2 = 0.0;
    /**
     * Generated from protobuf field <code>repeated .claros.instrument.CalibrationData.CalibrationStandard calibrationStandard = 11;</code>
     */
     ...
     *     @type float $r2
     *           r-squared of the calibration curve
     *     @type \Claros\Instrument\CalibrationData\CalibrationStandard[]|\Google\Protobuf\Internal\RepeatedField $calibrationStandard
     * }
     */
     ...
     */
    public function getCalibrationStandard()
    {
    ...
    /**
     * Generated from protobuf field <code>repeated .claros.instrument.CalibrationData.CalibrationStandard calibrationStandard = 11;</code>
     * @param \Claros\Instrument\CalibrationData\CalibrationStandard[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setCalibrationStandard($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Claros\Instrument\CalibrationData\CalibrationStandard::class);
        $this->calibrationStandard = $arr;
...
class_alias(Calibration::class, \Claros\Instrument\CalibrationData_Calibration::class);
