...
/**
 * Generated from protobuf message <code>claros.instrument.measurement.InstrumentMeasurementDefinition</code>
 */
class InstrumentMeasurementDefinition extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type bool $isVisible
     *           Soft delete of the Instrument Measurment Collection
     *     @type \Claros\Instrument\Measurement\SCSensorBinding $scSensorBinding
     *           For SC Instruments, how the SC Instrument is identified
     *     @type \Claros\Instrument\Measurement\MilliAmpBinding $milliAmpBinding
     ...
     * For SC Instruments, how the SC Instrument is identified
     *
     * Generated from protobuf field <code>.claros.instrument.measurement.SCSensorBinding scSensorBinding = 8;</code>
     * @return \Claros\Instrument\Measurement\SCSensorBinding
     */
     ...
     *
     * Generated from protobuf field <code>.claros.instrument.measurement.SCSensorBinding scSensorBinding = 8;</code>
     * @param \Claros\Instrument\Measurement\SCSensorBinding $var
     * @return $this
     */
    public function setScSensorBinding($var)
    {
        GPBUtil::checkMessage($var, \Claros\Instrument\Measurement\SCSensorBinding::class);
     ...
     * For 4-20 mA input, how the inputs are mapped to instrument measurments
     *
     * Generated from protobuf field <code>.claros.instrument.measurement.MilliAmpBinding milliAmpBinding = 9;</code>
     * @return \Claros\Instrument\Measurement\MilliAmpBinding
     */
     ...
     *
     * Generated from protobuf field <code>.claros.instrument.measurement.MilliAmpBinding milliAmpBinding = 9;</code>
     * @param \Claros\Instrument\Measurement\MilliAmpBinding $var
     * @return $this
     */
    public function setMilliAmpBinding($var)
    {
        GPBUtil::checkMessage($var, \Claros\Instrument\Measurement\MilliAmpBinding::class);
