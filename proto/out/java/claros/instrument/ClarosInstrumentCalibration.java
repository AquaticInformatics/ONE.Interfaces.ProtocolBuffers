...
public final class ClarosInstrumentCalibration {
  private ClarosInstrumentCalibration() {}
  ...
  public interface CalibrationOrBuilder extends
      // @@protoc_insertion_point(interface_extends:claros.instrument.Calibration)
    ...
    /**
     * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
     */
    java.util.List<claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard> 
        getCalibrationStandardsList();
    /**
     * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
     */
    claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard getCalibrationStandards(int index);
    /**
     * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
     */
     ...
     * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
     */
    java.util.List<? extends claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandardOrBuilder> 
        getCalibrationStandardsOrBuilderList();
    /**
     * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
     */
    claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandardOrBuilder getCalibrationStandardsOrBuilder(
        int index);
  }
  /**
   * Protobuf type {@code claros.instrument.Calibration}
   */
  public  static final class Calibration extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:claros.instrument.Calibration)
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 90: {
              if (!((mutable_bitField0_ & 0x00000400) != 0)) {
                calibrationStandards_ = new java.util.ArrayList<claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard>();
                mutable_bitField0_ |= 0x00000400;
              }
              calibrationStandards_.add(
                  input.readMessage(claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return claros.instrument.ClarosInstrumentCalibration.internal_static_claros_instrument_Calibration_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return claros.instrument.ClarosInstrumentCalibration.internal_static_claros_instrument_Calibration_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              claros.instrument.ClarosInstrumentCalibration.Calibration.class, claros.instrument.ClarosInstrumentCalibration.Calibration.Builder.class);
    }
    ...
    private java.util.List<claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard> calibrationStandards_;
    /**
     * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
     */
    public java.util.List<claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard> getCalibrationStandardsList() {
      return calibrationStandards_;
    }
    /**
     * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
     */
    public java.util.List<? extends claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandardOrBuilder> 
        getCalibrationStandardsOrBuilderList() {
      return calibrationStandards_;
    }
    /**
     ...
     * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
     */
    public claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard getCalibrationStandards(int index) {
      return calibrationStandards_.get(index);
    }
    /**
     * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
     */
    public claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandardOrBuilder getCalibrationStandardsOrBuilder(
        int index) {
      return calibrationStandards_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof claros.instrument.ClarosInstrumentCalibration.Calibration)) {
        return super.equals(obj);
      }
      claros.instrument.ClarosInstrumentCalibration.Calibration other = (claros.instrument.ClarosInstrumentCalibration.Calibration) obj;
    ...
    public static claros.instrument.ClarosInstrumentCalibration.Calibration parseFrom(
    ...
    public static claros.instrument.ClarosInstrumentCalibration.Calibration parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static claros.instrument.ClarosInstrumentCalibration.Calibration parseFrom(
    ...
    public static claros.instrument.ClarosInstrumentCalibration.Calibration parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static claros.instrument.ClarosInstrumentCalibration.Calibration parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static claros.instrument.ClarosInstrumentCalibration.Calibration parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(claros.instrument.ClarosInstrumentCalibration.Calibration prototype) {
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:claros.instrument.Calibration)
        claros.instrument.ClarosInstrumentCalibration.CalibrationOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return claros.instrument.ClarosInstrumentCalibration.internal_static_claros_instrument_Calibration_descriptor;
      }
      ...
      // Construct using claros.instrument.ClarosInstrumentCalibration.Calibration.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public claros.instrument.ClarosInstrumentCalibration.Calibration getDefaultInstanceForType() {
        return claros.instrument.ClarosInstrumentCalibration.Calibration.getDefaultInstance();
      }

      @java.lang.Override
      public claros.instrument.ClarosInstrumentCalibration.Calibration build() {
        claros.instrument.ClarosInstrumentCalibration.Calibration result = buildPartial();
      ...
      @java.lang.Override
      public claros.instrument.ClarosInstrumentCalibration.Calibration buildPartial() {
        claros.instrument.ClarosInstrumentCalibration.Calibration result = new claros.instrument.ClarosInstrumentCalibration.Calibration(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof claros.instrument.ClarosInstrumentCalibration.Calibration) {
          return mergeFrom((claros.instrument.ClarosInstrumentCalibration.Calibration)other);
        } else {
      ...
      public Builder mergeFrom(claros.instrument.ClarosInstrumentCalibration.Calibration other) {
        if (other == claros.instrument.ClarosInstrumentCalibration.Calibration.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        claros.instrument.ClarosInstrumentCalibration.Calibration parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (claros.instrument.ClarosInstrumentCalibration.Calibration) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
      ...
      private void ensureCalibrationStandardsIsMutable() {
        if (!((bitField0_ & 0x00000400) != 0)) {
          calibrationStandards_ = new java.util.ArrayList<claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard>(calibrationStandards_);
          bitField0_ |= 0x00000400;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard, claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard.Builder, claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandardOrBuilder> calibrationStandardsBuilder_;
      ...
      public Builder setCalibrationStandards(
          int index, claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard value) {
        if (calibrationStandardsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setCalibrationStandards(
          int index, claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard.Builder builderForValue) {
        if (calibrationStandardsBuilder_ == null) {
          ensureCalibrationStandardsIsMutable();
       ...
       * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
       */
      public Builder addCalibrationStandards(claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard value) {
        if (calibrationStandardsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addCalibrationStandards(
          claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard.Builder builderForValue) {
        if (calibrationStandardsBuilder_ == null) {
          ensureCalibrationStandardsIsMutable();
      ...
      public Builder addAllCalibrationStandards(
          java.lang.Iterable<? extends claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard> values) {
        if (calibrationStandardsBuilder_ == null) {
          ensureCalibrationStandardsIsMutable();
       ...
       * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
       */
      public claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard.Builder getCalibrationStandardsBuilder(
          int index) {
       ...
       * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
       */
      public claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard.Builder addCalibrationStandardsBuilder() {
        return getCalibrationStandardsFieldBuilder().addBuilder(
            claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard.getDefaultInstance());
      }
      /**
       * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
       */
      public claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard.Builder addCalibrationStandardsBuilder(
          int index) {
        return getCalibrationStandardsFieldBuilder().addBuilder(
            index, claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard.getDefaultInstance());
      }
      /**
       * <code>repeated .claros.instrument.CalibrationStandard calibrationStandards = 11;</code>
       */
      public java.util.List<claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard.Builder> 
           getCalibrationStandardsBuilderList() {
        return getCalibrationStandardsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard, claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandard.Builder, claros.instrument.ClarosInstrumentCalibrationStandard.CalibrationStandardOrBuilder> 
          getCalibrationStandardsFieldBuilder() {
        if (calibrationStandardsBuilder_ == null) {
      ...
      // @@protoc_insertion_point(builder_scope:claros.instrument.Calibration)
    }

    // @@protoc_insertion_point(class_scope:claros.instrument.Calibration)
    private static final claros.instrument.ClarosInstrumentCalibration.Calibration DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new claros.instrument.ClarosInstrumentCalibration.Calibration();
    }

    public static claros.instrument.ClarosInstrumentCalibration.Calibration getDefaultInstance() {
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_claros_instrument_Calibration_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_claros_instrument_Calibration_fieldAccessorTable;
    ...
    com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          claros.instrument.ClarosInstrumentCalibrationStandard.getDescriptor(),
        }, assigner);
    internal_static_claros_instrument_Calibration_descriptor =
      getDescriptor().getMessageTypes().get(0);
    internal_static_claros_instrument_Calibration_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_claros_instrument_Calibration_descriptor,
