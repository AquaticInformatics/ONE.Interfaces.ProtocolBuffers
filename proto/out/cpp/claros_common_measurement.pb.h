...
#ifndef PROTOBUF_INCLUDED_claros_5fcommon_5fmeasurement_2eproto
#define PROTOBUF_INCLUDED_claros_5fcommon_5fmeasurement_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_claros_5fcommon_5fmeasurement_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_claros_5fcommon_5fmeasurement_2eproto {
...
namespace google {
namespace protobuf {
template<> ::claros::common::Measurement* Arena::CreateMaybeMessage<::claros::common::Measurement>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace claros {
namespace common {
...
class Measurement :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:claros.common.Measurement) */ {
 public:
  Measurement();
  virtual ~Measurement();
 ...
 private:
  ...
  friend struct ::TableStruct_claros_5fcommon_5fmeasurement_2eproto;
};
// ===================================================================
...
inline const ::claros::common::DateTime& Measurement::timestamp() const {
  const ::claros::common::DateTime* p = timestamp_;
  // @@protoc_insertion_point(field_get:claros.common.Measurement.timestamp)
  return p != nullptr ? *p : *reinterpret_cast<const ::claros::common::DateTime*>(
      &::claros::common::_DateTime_default_instance_);
}
inline ::claros::common::DateTime* Measurement::release_timestamp() {
  // @@protoc_insertion_point(field_release:claros.common.Measurement.timestamp)
  
  ::claros::common::DateTime* temp = timestamp_;
  timestamp_ = nullptr;
  return temp;
}
inline ::claros::common::DateTime* Measurement::mutable_timestamp() {
  
  if (timestamp_ == nullptr) {
    auto* p = CreateMaybeMessage<::claros::common::DateTime>(GetArenaNoVirtual());
    timestamp_ = p;
  }
  // @@protoc_insertion_point(field_mutable:claros.common.Measurement.timestamp)
  return timestamp_;
}
inline void Measurement::set_allocated_timestamp(::claros::common::DateTime* timestamp) {
  ...
  // @@protoc_insertion_point(field_set_allocated:claros.common.Measurement.timestamp)
}
...
inline ::google::protobuf::int32 Measurement::parameterid() const {
  // @@protoc_insertion_point(field_get:claros.common.Measurement.parameterId)
  return parameterid_;
}
inline void Measurement::set_parameterid(::google::protobuf::int32 value) {
  
  parameterid_ = value;
  // @@protoc_insertion_point(field_set:claros.common.Measurement.parameterId)
}
...
inline const ::std::string& Measurement::parameterguid() const {
  // @@protoc_insertion_point(field_get:claros.common.Measurement.parameterGuid)
...
inline void Measurement::set_parameterguid(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:claros.common.Measurement.parameterGuid)
}
#if LANG_CXX11
inline void Measurement::set_parameterguid(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:claros.common.Measurement.parameterGuid)
}
#endif
inline void Measurement::set_parameterguid(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:claros.common.Measurement.parameterGuid)
}
inline void Measurement::set_parameterguid(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:claros.common.Measurement.parameterGuid)
}
inline ::std::string* Measurement::mutable_parameterguid() {
  
  // @@protoc_insertion_point(field_mutable:claros.common.Measurement.parameterGuid)
...
inline ::std::string* Measurement::release_parameterguid() {
  // @@protoc_insertion_point(field_release:claros.common.Measurement.parameterGuid)
...
inline void Measurement::set_allocated_parameterguid(::std::string* parameterguid) {
  ...
  // @@protoc_insertion_point(field_set_allocated:claros.common.Measurement.parameterGuid)
}
...
inline ::google::protobuf::int32 Measurement::unitid() const {
  // @@protoc_insertion_point(field_get:claros.common.Measurement.unitId)
  return unitid_;
}
inline void Measurement::set_unitid(::google::protobuf::int32 value) {
  
  unitid_ = value;
  // @@protoc_insertion_point(field_set:claros.common.Measurement.unitId)
}
...
inline const ::std::string& Measurement::unitguid() const {
  // @@protoc_insertion_point(field_get:claros.common.Measurement.unitGuid)
...
inline void Measurement::set_unitguid(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:claros.common.Measurement.unitGuid)
}
#if LANG_CXX11
inline void Measurement::set_unitguid(::std::string&& value) {
  ...
  unitguid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:claros.common.Measurement.unitGuid)
}
#endif
inline void Measurement::set_unitguid(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:claros.common.Measurement.unitGuid)
}
inline void Measurement::set_unitguid(const char* value, size_t size) {
  ...
  unitguid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:claros.common.Measurement.unitGuid)
}
inline ::std::string* Measurement::mutable_unitguid() {
  
  // @@protoc_insertion_point(field_mutable:claros.common.Measurement.unitGuid)
...
inline ::std::string* Measurement::release_unitguid() {
  // @@protoc_insertion_point(field_release:claros.common.Measurement.unitGuid)
...
inline void Measurement::set_allocated_unitguid(::std::string* unitguid) {
  ...
  // @@protoc_insertion_point(field_set_allocated:claros.common.Measurement.unitGuid)
}
...
inline float Measurement::value() const {
  // @@protoc_insertion_point(field_get:claros.common.Measurement.value)
  return value_;
}
inline void Measurement::set_value(float value) {
  
  value_ = value;
  // @@protoc_insertion_point(field_set:claros.common.Measurement.value)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_claros_5fcommon_5fmeasurement_2eproto
