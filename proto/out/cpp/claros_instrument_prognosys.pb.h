...
#ifndef PROTOBUF_INCLUDED_claros_5finstrument_5fprognosys_2eproto
#define PROTOBUF_INCLUDED_claros_5finstrument_5fprognosys_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_claros_5finstrument_5fprognosys_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_claros_5finstrument_5fprognosys_2eproto {
...
class PrognosysData :
 ...
 private:
  ...
  friend struct ::TableStruct_claros_5finstrument_5fprognosys_2eproto;
};
// ===================================================================
...
// int32 id = 1;
inline void PrognosysData::clear_id() {
  id_ = 0;
}
inline ::google::protobuf::int32 PrognosysData::id() const {
  // @@protoc_insertion_point(field_get:claros.instrument.PrognosysData.id)
  return id_;
}
inline void PrognosysData::set_id(::google::protobuf::int32 value) {
  
  id_ = value;
  // @@protoc_insertion_point(field_set:claros.instrument.PrognosysData.id)
}

// float percent = 2;
inline void PrognosysData::clear_percent() {
  percent_ = 0;
}
inline float PrognosysData::percent() const {
  // @@protoc_insertion_point(field_get:claros.instrument.PrognosysData.percent)
  return percent_;
}
inline void PrognosysData::set_percent(float value) {
  
  percent_ = value;
  // @@protoc_insertion_point(field_set:claros.instrument.PrognosysData.percent)
}

// int32 days = 3;
inline void PrognosysData::clear_days() {
  days_ = 0;
}
inline ::google::protobuf::int32 PrognosysData::days() const {
  // @@protoc_insertion_point(field_get:claros.instrument.PrognosysData.days)
  return days_;
}
inline void PrognosysData::set_days(::google::protobuf::int32 value) {
  
  days_ = value;
  // @@protoc_insertion_point(field_set:claros.instrument.PrognosysData.days)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_claros_5finstrument_5fprognosys_2eproto
