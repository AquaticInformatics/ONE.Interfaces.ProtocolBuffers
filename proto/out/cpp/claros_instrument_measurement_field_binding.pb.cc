...
::google::protobuf::internal::SCCInfo<1> scc_info_InstrumentMeasurementFieldBinding_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsInstrumentMeasurementFieldBinding_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto}, {
      &scc_info_ClarosDateTime_claros_5fcommon_5fcore_5fclarosdatetime_2eproto.base,}};

void InitDefaults_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto() {
  ::google::protobuf::internal::InitSCC(&scc_info_InstrumentMeasurementFieldBinding_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto.base);
}

::google::protobuf::Metadata file_level_metadata_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto[1];
constexpr ::google::protobuf::EnumDescriptor const** file_level_enum_descriptors_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto = nullptr;
constexpr ::google::protobuf::ServiceDescriptor const** file_level_service_descriptors_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto = nullptr;
...
::google::protobuf::internal::AssignDescriptorsTable assign_descriptors_table_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto = {
  {}, AddDescriptors_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto, "claros_instrument_measurement_field_binding.proto", schemas,
  file_default_instances, TableStruct_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto::offsets,
  file_level_metadata_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto, 1, file_level_enum_descriptors_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto, file_level_service_descriptors_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto,
};
...
void AddDescriptors_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto() {
 ...
 ::google::protobuf::internal::AddDescriptors(&descriptor_table_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto, deps, 1);
}
...
class InstrumentMeasurementFieldBinding::HasBitSetters {
 public:
  static const ::claros::common::core::ClarosDateTime& timestamp(const InstrumentMeasurementFieldBinding* msg);
};

const ::claros::common::core::ClarosDateTime&
InstrumentMeasurementFieldBinding::HasBitSetters::timestamp(const InstrumentMeasurementFieldBinding* msg) {
  return *msg->timestamp_;
}
void InstrumentMeasurementFieldBinding::clear_timestamp() {
...
const int InstrumentMeasurementFieldBinding::kInstrumentMeasurementIdFieldNumber;
const int InstrumentMeasurementFieldBinding::kTimestampFieldNumber;
const int InstrumentMeasurementFieldBinding::kUnitIdFieldNumber;
...
void InstrumentMeasurementFieldBinding::SharedCtor() {
  ...
  ::memset(&timestamp_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&timestamp_)) + sizeof(unitid_));
}
...
void InstrumentMeasurementFieldBinding::SharedDtor() {
  instrumentmeasurementid_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  if (this != internal_default_instance()) delete timestamp_;
}

void InstrumentMeasurementFieldBinding::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const InstrumentMeasurementFieldBinding& InstrumentMeasurementFieldBinding::default_instance() {
  ::google::protobuf::internal::InitSCC(&::scc_info_InstrumentMeasurementFieldBinding_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto.base);
...
const char* InstrumentMeasurementFieldBinding::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<InstrumentMeasurementFieldBinding*>(object);
...
bool InstrumentMeasurementFieldBinding::MergePartialFromCodedStream(
...
bool InstrumentMeasurementFieldBinding::IsInitialized() const {
  return true;
}

void InstrumentMeasurementFieldBinding::Swap(InstrumentMeasurementFieldBinding* other) {
  if (other == this) return;
  InternalSwap(other);
}
void InstrumentMeasurementFieldBinding::InternalSwap(InstrumentMeasurementFieldBinding* other) {
  using std::swap;
...
::google::protobuf::Metadata InstrumentMeasurementFieldBinding::GetMetadata() const {
  ::google::protobuf::internal::AssignDescriptors(&::assign_descriptors_table_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto);
  return ::file_level_metadata_claros_5finstrument_5fmeasurement_5ffield_5fbinding_2eproto[kIndexInFileMessages];
}
