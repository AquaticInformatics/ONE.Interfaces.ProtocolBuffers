...
#include "claros_common_configuration_configuration.pb.h"
...
static bool dynamic_init_dummy_claros_5fcommon_5fconfiguration_5fconfiguration_2eproto = []() { AddDescriptors_claros_5fcommon_5fconfiguration_5fconfiguration_2eproto(); return true; }();
namespace claros {
namespace common {
namespace configuration {
...
void Configuration::SharedCtor() {
  ::google::protobuf::internal::InitSCC(
      &scc_info_Configuration_claros_5fcommon_5fconfiguration_5fconfiguration_2eproto.base);
  id_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  createdbyid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  modifiedbyid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  configurationdata_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
::google::protobuf::Metadata Configuration::GetMetadata() const {
  ...
  return ::file_level_metadata_claros_5fcommon_5fconfiguration_5fconfiguration_2eproto[kIndexInFileMessages];
}
