...
typedef GPB_ENUM(ReportableQualifierDefinitionType) {
  /**
 ...
 **/
BOOL ReportableQualifierDefinitionType_IsValidValue(int32_t value);
 ...
 **/
@interface ClarosCommonCoreReportablequalifierdefinitionTypeRoot : GPBRootObject
@end
