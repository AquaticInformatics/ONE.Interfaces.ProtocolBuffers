 ...
 **/
@interface ClarosCommonConfigurationPrivilegesRoot : GPBRootObject
@end

#pragma mark - Privileges

typedef GPB_ENUM(Privileges_FieldNumber) {
  Privileges_FieldNumber_Privilege = 1,
};

@interface Privileges : GPBMessage
