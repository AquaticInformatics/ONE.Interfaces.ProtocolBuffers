 ...
 **/
@interface ClarosInstrumentSettingDataRoot : GPBRootObject
@end

#pragma mark - Settings

typedef GPB_ENUM(Settings_FieldNumber) {
  Settings_FieldNumber_SettingsArray = 1,
};

@interface Settings : GPBMessage

@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<Setting*> *settingsArray;
...
typedef GPB_ENUM(Setting_FieldNumber) {
  Setting_FieldNumber_Settings = 1,
};
