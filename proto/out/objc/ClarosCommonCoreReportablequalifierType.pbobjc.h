...
typedef GPB_ENUM(ReportableQualifierType) {
  /**
 ...
 **/
BOOL ReportableQualifierType_IsValidValue(int32_t value);
 ...
 **/
@interface ClarosCommonCoreReportablequalifierTypeRoot : GPBRootObject
@end
